...
CREATE TABLE MEDICAL_MRI_FOLDER (
    -- 시퀀스 없이 여기서 한방에 해결!
                                    MRI_ID              NUMBER         GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                    PATIENT_ID          VARCHAR2(20)   NOT NULL,
...
-- [7-1] 최근 기록 테이블 : MRI_ACCESS_LOG // MRI 폴더 기록 테이블 // 의사,환자 전용임
CREATE TABLE MRI_ACCESS_LOG (
                                ...
                                CONSTRAINT FK_LOG_MRI FOREIGN KEY (MRI_ID) REFERENCES MEDICAL_MRI_FOLDER(MRI_ID),
...
CREATE TABLE DIAGNOSIS_REPORT (
                                  ...
                                  CONSTRAINT FK_REPORT_MRI FOREIGN KEY (MRI_ID)
                                      REFERENCES MEDICAL_MRI_FOLDER(MRI_ID), -- 의사 전용 테이블이기 때문에 일반 사용자 x
...
CREATE TABLE TUMOR_ANNOTATION (
                                  ...
                                  CONSTRAINT FK_ANNOT_MRI FOREIGN KEY (MRI_ID)
                                      REFERENCES MEDICAL_MRI_FOLDER(MRI_ID), -- 의사가 마킹하기 때문에 패스.
...
-- 아직 안 넣음..
INSERT INTO MEDICAL_MRI_FOLDER(PATIENT_ID, DOCTOR_ID, IMAGE_FOLDER_PATH, UPLOAD_DT, TOTAL_SLICES, STATUS, AI_ANALYSIS_STATUS, AI_MODEL_VERSION)
VALUES('1','DOC-25-001','/home/test/1','2025-12-20','100','UPLOADED','PENDING','1.0');
